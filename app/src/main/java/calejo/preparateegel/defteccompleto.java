...
public class defteccompleto extends AppCompatActivity {
    String rCorrecta;
    int cont = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defteccompleto);
    ...
    void setTextInicio(PreguntasWebService pregunta) {
        ...
        if (preguntaA == null || preguntaA.equals("")) {
            Intent intent = new Intent(this, defteccompleto.class);
