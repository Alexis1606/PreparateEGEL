...
public class defuvm2completo extends AppCompatActivity {
    String rCorrecta;
    int cont = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defuvm2completo);
    ...
    void setTextInicio(PreguntasWebService pregunta) {
        ...
        if (preguntaA == null || preguntaA.equals("")) {
            Intent intent = new Intent(this, defuvm2completo.class);
